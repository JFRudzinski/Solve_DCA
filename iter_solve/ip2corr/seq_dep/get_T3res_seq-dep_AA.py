...
# Treat the triplets independently
...
lcc_cc_234 = pyemma.msm.estimation.largest_connected_set(Cmat_234, directed=True)
Cmat_cc_234 = pyemma.msm.estimation.largest_connected_submatrix(Cmat_234, directed=True, lcc=lcc_cc_234)
Tmle_cc_234 = pyemma.msm.estimation.transition_matrix(Cmat_cc_234, reversible=True)
lcc_cc_345 = pyemma.msm.estimation.largest_connected_set(Cmat_345, directed=True)
Cmat_cc_345 = pyemma.msm.estimation.largest_connected_submatrix(Cmat_345, directed=True, lcc=lcc_cc_345)
Tmle_cc_345 = pyemma.msm.estimation.transition_matrix(Cmat_cc_345, reversible=True)
lcc_cc_456 = pyemma.msm.estimation.largest_connected_set(Cmat_456, directed=True)
Cmat_cc_456 = pyemma.msm.estimation.largest_connected_submatrix(Cmat_456, directed=True, lcc=lcc_cc_456)
Tmle_cc_456 = pyemma.msm.estimation.transition_matrix(Cmat_cc_456, reversible=True)
...
np.save('T3res_0',Tmle_cc_234)
np.save('T3res_1',Tmle_cc_345)
np.save('T3res_2',Tmle_cc_456)
# full
