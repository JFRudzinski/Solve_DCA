...
Nres = 5
Ncorr = 2 # == k
end_state = 0 # helices at the ends
...
for res in range(2*Ncorr):
    for s1 in range(len(states_kp1res)):
        ...
        if ( res == 0 ):
            ...
            if ( states_kp1res[s1][0] == end_state ):
                P1_b1 = 1.
            else:
                P1_b1 = 0.
            if ( states_kp1res[s1][1] == end_state ):
                P1_b0 = 1.
            else:
                P1_b0 = 0.
            ...
            if ( states_kp1res[s1][2] == end_state ):
                P1_e0 = 1.
            else:
                P1_e0 = 0.
    ...
    for s1 in range(len(states_kp1res)):
        for s2 in range(len(states_kp1res)):
            ...
            if ( res == 0 ):
                ...
                if ( states_kp1res[s2][0] == end_state ):
                    P1_b1 = 1.
                else:
                    P1_b1 = 0.
                if ( states_kp1res[s2][1] == end_state ):
                    P1_b0 = 1.
                else:
                    P1_b0 = 0.
                ...
                if ( states_kp1res[s2][2] == end_state ):
                    P1_e0 = 1.
                else:
                    P1_e0 = 0.
...
for res in range(2*Ncorr):
    for s1 in range(len(states_kres)):
        ...
        if ( (res == 0) or (res==3) ):
            if ( (states_kres[s1][0] == end_state) and (states_kres[s1][1] == end_state) ):
                val = 1.
            else:
                val = 0.
...
for res in range(2*Ncorr):
    for s1 in range(len(states_kres)):
        for s2 in range(len(states_kres)):
            ...
            if ( (res == 0) or (res == 3) ):
                if ( (states_kres[s2][0] == end_state) and (states_kres[s2][1] == end_state) ):
                    val = 1.
                else:
                    val = 0.
